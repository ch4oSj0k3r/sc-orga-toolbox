                ...
                <div className="space-y-6">
                    <div className="rounded-md bg-sky-500/10 p-4 border border-sky-500/20">
                        ...
                        <p className="text-sm text-slate-300 leading-relaxed">
                            Um sicherzustellen, dass dieses RSI-Handle wirklich dir gehört, kopiere
                            bitte den unten stehenden Code und füge ihn in deine
            ...
            {userStatus === 'VERIFIED' && (
                <div className="space-y-6">
                    <div className="rounded-md bg-amber-500/10 p-4 border border-amber-500/20">
                        ...
                        <p className="text-sm text-slate-300 leading-relaxed">
                            Dein RSI-Handle wurde **erfolgreich verifiziert**! Du kannst den Code
                            jetzt wieder aus deiner RSI-Biografie löschen, wenn du möchtest.
                        </p>
                    </div>
