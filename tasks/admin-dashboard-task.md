...
- [ ] **Middleware-Schutz:** Die `proxy.ts` (oder `middleware.ts`) erweitern, um die Route `/admin` strikt für alle User zu sperren, die nicht die Rolle `Role.ADMIN` besitzen.
